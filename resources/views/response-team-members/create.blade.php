...
@section('title', 'إضافة عضو فريق استجابة')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">إضافة عضو فريق استجابة جديد</h5>
                <a href="{{ route('response-team-members.index') }}" class="btn btn-secondary">
                    <i class="bx bx-arrow-back"></i> العودة للقائمة
                </a>
            </div>
            <div class="card-body">
                <form action="{{ route('response-team-members.store') }}" method="POST" id="createForm">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('response_point_id') is-invalid @enderror" id="response_point_id" name="response_point_id" required>
                                ...
                                @foreach($responsePoints as $point)
                                    <option value="{{ $point->id }}" {{ old('response_point_id', request('response_point_id')) == $point->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 mt-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_leader" name="is_leader" value="1" {{ old('is_leader') ? 'checked' : '' }}>
